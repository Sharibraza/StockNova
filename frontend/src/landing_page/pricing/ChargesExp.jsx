...
function ChargesExp() {
    let styles = { fontSize: ".75rem", color: "grey" };
    return (
        <div className="container p-5">
            <div className="row p-5">
                ...
                <div className="col mt-5 text-muted">
                    ...
                    <p>BSE has revised transaction charges for group A, B and other non <br />exclusive scrips (non-exclusive scrips from group E, F, FC, G, GC, W, T) at ₹375 per crore of turnover on flat rate basis w.e.f. December 1, 2022.</p>
                ...
                <div className="col mt-5 text-muted">
                    <h6>GST</h6>
                    <p>Tax levied by the government on the services rendered. 18% of ( brokerage + SEBI charges <br /> + transaction charges)</p>
                    ...
                    <p>For BSDA demat account: Zero charges if the holding value is less than ₹4,00,000. To learn more <br />about BSDA, <a href="#" style={styles} className=' text-primary text-decoration-none '> Click here</a></p>
                    <p>For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly (90 days). To learn more <br />about AMC, <a href="#" style={styles} className=' text-primary text-decoration-none '> Click here</a></p>
                    ...
                    <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading <br />account. <a href="#" style={styles} className=' text-primary text-decoration-none '> Learn more</a></p>
